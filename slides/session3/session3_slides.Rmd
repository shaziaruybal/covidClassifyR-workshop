...
institute: "Presented at the covidClassifyR Shiny app workshop for researchers from PNGIMR and partner institutions"  
date: '2022-03-10'
output:
  xaringan::moon_reader:
    css: xaringan-themer.css
    # css: ["default", "default-fonts", "robot"]
    nature:
...
meta() %>%
  ...
  meta_social(
    ...
    url = "https://shaziaruybal.github.io/covidClassifyR-workshop/slides/session3",
...
.footnote[
For the materials for sessions 1 and 2 see the [`r fontawesome::fa("external-link-alt")`](https://shaziaruybal.github.io/covidClassifyR-workshop/) 
]
---
...
---
class: inverse
# Why was covidClassifyR developed?
...
## covidClassifyR was developed fit-for-purpose to streamline the processing of serological data generated using the COVID-19 multi-antigen serological assay. 

---
class: inverse

## covidClassifyR allows you to:
...
### `r fontawesome::fa("check-square")` Access the [`covidClassifyR`](https://shaziaruybal.shinyapps.io/covidclassifyr) Shiny web application
...
.footnote[These slides were created using the R packages:  
...
.footnote[
[`r fontawesome::fa("image")` Slides for Session 3](https://shaziaruybal.github.io/covidClassifyR/slides/session3/session3_slides.html)  
[`r icon::fa("youtube")` Recording]()   
[`r fontawesome::fa("github")` Workshop materials](https://github.com/shaziaruybal/covidClassifyR-workshop/sessions/2022-03-10-session3/index.html)
]
