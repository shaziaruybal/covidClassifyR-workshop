...
title: "Session 10"
description: |
  Recap of data QC and classification
author: 
...
### Description:
In this session we will go over how to QC and apply the classification algorithm to your data in the [`covidClassifyR`](https://shaziaruybal.shinyapps.io/covidclassifyr) app. 

### <i class="fas fa-calendar-alt"></i> Session details:
24th March 2022, 08:30-09:00 am GMT+10
