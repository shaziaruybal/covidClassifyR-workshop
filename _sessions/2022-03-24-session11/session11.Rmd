...
title: "Session 11"
description: |
  How to visualize your data in the covidClassifyR app
author: 
...
```
### Description:
In this session we will go over to perform preliminary visualizations of your data in the [`covidClassifyR`](https://shaziaruybal.shinyapps.io/covidclassifyr) app. 

### <i class="fas fa-calendar-alt"></i> Session details:
24th March 2022, 09:00-09:30 am GMT+10
