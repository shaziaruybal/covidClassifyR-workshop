...
title: "Session 3"
description: |
  Introduction to the [`covidClassifyR`](https://shaziaruybal.shinyapps.io/covidclassifyr) Shiny application
author: 
...
```
### Description:
In this session you will go over how the [`covidClassifyR`](https://shaziaruybal.shinyapps.io/covidclassifyr) app and a brief introduction to the features


### <i class="fas fa-calendar-alt"></i> Session details:
10th March 2022, 10:00-10:30am GMT+10
