...
title: "Session 8"
description: |
  Introduction to the COVID-19 classification algorithm that can be applied in the covidClassifyR Shiny app
author: 
...
### Description:
In this session we will go over the COVID-19 classification algorithm that is built-in the [`covidClassifyR`](https://shaziaruybal.shinyapps.io/covidclassifyr) app. 

### <i class="fas fa-calendar-alt"></i> Session details:
17th March 2022, 09:00-09:30 am GMT+10
...
icon_link(icon = "fas fa-play-circle",
          text = "Recording",
          url = "https://youtu.be/V2d3TbGtt0I")
```
