---
title: "covidClassifyR Shiny app workshop for PNGIMR researchers"
author: 
...
date: March 8 2022
description: |
  A four-day workshop on how to use the covidClassifyR Shiny web application, designed for Papua New Guinea Institute of Medical Research scientific researchers
...
- **Day 1:** 
  ...
  - Session 1: Introduction to the SARS-CoV-2 Luminex multi-antigen serology assay
  - Session 2: Introduction to the COVID-19 serological surveys that have been conducted in PNG
  - Session 3: Introduction to the [`covidClassifyR`](https://shaziaruybal.shinyapps.io/covidclassifyr) Shiny application
...
- **Day 2:** 
  ...
  - Session 4: Data preparation and how to go from Luminex machine to [`covidClassifyR`](https://shaziaruybal.shinyapps.io/covidclassifyr) app
  - Session 5: How to perform quality control of your data 
  - Session 6: Generate your quality control report and look at your processed data
...
- **Day 3:** 
  ...
  - Session 7: Recap of how to perform quality control of your data 
  - Session 8: Introduction to the COVID-19 classification algorithm
...
- **Day 4:** 
  ...
  - Session 1: Recap of data QC and classification
  - Session 2: How to visualize your data in the [`covidClassifyR`](https://shaziaruybal.shinyapps.io/covidclassifyr) app
  - Session 3: Bring your own data to work on
...
# Workshop materials
All of the slides and session materials can be found in [Workshop materials](#materials.html)
