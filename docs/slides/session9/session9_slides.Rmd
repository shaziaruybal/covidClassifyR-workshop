---
title: "Session 9: How to apply the classification algorithm to your data"
author: 
...
meta() %>%
  meta_name("github-repo" = "shaziaruybal/covidClassifyR-workshop/slides/session9") %>% 
  meta_social(
    title = "Session 9: How to apply the classification algorithm to your data",
    description = paste(
    ...
    image = "https://shaziaruybal.github.io/covidClassifyR-workshop/slides/session9/img/social-share-card.png",
    image_alt = paste(
      "Title slide of Session 9: How to apply the classification algorithm to your data", 
      "created for researchers from the Papua New Guinea Institute of Medical Research and partner institutions"
    ),
    og_type = "website",
...
#### `r fontawesome::fa("check-square")` **[Session 5](https://shaziaruybal.github.io/covidClassifyR-workshop/sessions/2022-03-11-session5/index.html)** gave you an overview of how to prepare your data and upload your data to the [`covidClassifyR`](https://shaziaruybal.shinyapps.io/covidclassifyr) app
...
#### `r fontawesome::fa("check-square")` **[Session 8](https://shaziaruybal.github.io/covidClassifyR-workshop/sessions/2022-03-17-session8/index.html)** gave you an overview of the classification algorithm
...
--
### How to apply the algorithm to your data
...
## `r fontawesome::fa("network-wired")` Classify your data

.panelset.sideways[

.panel[.panel-name[Upload your data files]
...
.panel[.panel-name[Select the algorithm]

.pull-left[

The PNG algorithm should be used for data generated using the COVID-19 Luminex assay established at PNGIMR

_*Note: the ability to upload already processed data is in development, for now you must upload raw data and your plate layout in order to run the classification algorithm on your data_

]

.pull-right[

![](img/classification_select.png)
```{r echo=F, eval=F, out.height=350, out.width=300}
knitr::include_graphics("img/classification_select.png")
```
]
]

.panel[.panel-name[Check your classification data]

<video width="1330" height="410" controls>
  <source src="screen_records/eg_classify.mp4" type="video/mp4"> 
</video>
...
.panel[.panel-name[Download your classification data]

You can download your classification data, by navigating to the "Download data" tab. Make sure that you click on the correct button depending on the algorithm you applied to your data. 


![](img/download.png)

**`r fontawesome::fa("lightbulb")` Tip:** The downloaded .csv file will include the algorithm in the file name, which you can also cross-check to make sure the appropriate algorithm was applied to classify the data.
]
...
### `r fontawesome::fa("check-square")` Try to import the raw data and explore the "Classification" tab

--

### `r fontawesome::fa("check-square")` Download your classification data
...
### [`r icon::fa("youtube")` Recording](https://youtu.be/LDihJvJZ3MQ)  
...
### [`r fontawesome::fa("image")` Slides for Session 9](https://shaziaruybal.github.io/covidClassifyR-workshop/slides/session7/session9_slides.html)
]
