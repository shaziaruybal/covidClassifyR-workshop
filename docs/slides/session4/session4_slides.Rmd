...
meta() %>%
  ...
  meta_social(
    title = "Session 4: Data preparation and how to go from Luminex machine to ClassifyR Shiny web application",
    description = paste(
...
### `r fontawesome::fa("check-square")` **Session 3** gave you an overview of the [`covidClassifyR`](https://shaziaruybal.shinyapps.io/covidclassifyr) Shiny app

--

.footnote[
For the materials for session 3 see the [workshop website `r fontawesome::fa("external-link-alt")`](https://shaziaruybal.github.io/covidClassifyR-workshop/sessions/2022-03-10-session3/index.html) 
]
...
#### Your raw data should be exported in .xlsx format 
...
**`r fontawesome::fa("lightbulb")` Tip:** by supplying the plate layout, the Shiny app will match your sample codes/IDs to the appropriate antibody data from the unknown samples
...
<!-- ![](img/import_buttons.png) -->
]

.panel[.panel-name[Experiment info details]
- You can change the experiment name by typing directly in the text box with the experiment name that best describes your particular data/Luminex run. For example, you can label it as “MyExperimentName_Plate01”. 
...
<video width="1330" height="410" controls>
  <source src="img/edit_import.mp4" type="video/mp4"> 
</video>
]
...
<video width="1330" height="410" controls>
  <source src="img/upload_files.mp4" type="video/mp4"> 
</video>
...
.pull-right[
`r fa("check-square")` Make sure that your sample labels in the plate layout are as follows:
...
### [`r fontawesome::fa("image")` Slides for Session 3](https://shaziaruybal.github.io/covidClassifyR-workshop/slides/session4/session4_slides.html)
]
